...
public class ShopFragment extends Fragment implements ShopContentLayout.ScrollableProvider {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_shop_details_shop, null);
