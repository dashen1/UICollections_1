package com.example.tiktolkcommentdialog.activity.multi;
...
import com.example.tiktolkcommentdialog.adapter.CommentDialogMutiAdapter;
import com.example.tiktolkcommentdialog.bean.CommentEntity;
import com.example.tiktolkcommentdialog.bean.CommentMoreBean;
import com.example.tiktolkcommentdialog.bean.FirstLevelBean;
import com.example.tiktolkcommentdialog.bean.SecondLevelBean;
import com.example.tiktolkcommentdialog.dialog.InputTextMsgDialog;
import com.example.tiktolkcommentdialog.listener.SoftKeyBoardListener;
import com.example.tiktolkcommentdialog.util.RecyclerViewUtil;
...
public class CommentMultiActivity extends AppCompatActivity implements BaseQuickAdapter.RequestLoadMoreListener {
    ...
    private String content = "不敢再忘记你。如果真的有一天";
    ...
    private void initData() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            firstLevelBean.setHeadInt(R.mipmap.head);
            ...
            for (int j = 0; j < 10; j++) {
                ...
                secondLevelBean.setHeadInt(R.mipmap.child);
